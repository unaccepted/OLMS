...
<html lang="en">
   ...
   <body>
	  	...
	  	$(document).ready(function() {
	  	  $('#submitBtn').click(function(event) {
				...
				$.ajax({
					...
					url : "/olmsb-web/member/books/return/validate",
	 ...
	 <div class="page-header">
			<h4 id="pagetitle">Return Book Query</h4>
		</div>
	 <div class="form-container">
	 		 	<form:form id="issueForm" method="POST" action="/olmsb-web/member/books/return/submit" modelAttribute="issueDto">
