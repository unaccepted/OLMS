...
<body>
						...
						function() {
							$("#parentCheck")
									.change(
											function() {
												$(
														"input:checkbox[name=selecteduser]")
														.prop(
																'checked',
																$(this)
																		.prop(
							...
							$('#removeBtn')
									.click(
											function(event) {
												var selectedUsers = [];
												$(
														"input:checkbox[name=selecteduser]:checked")
														.each(
																function() {
																	selectedUsers
																			.push($(
																		...
																		if (result) {
																			$
																					.ajax({
																						...
																						url : "/olmsb-web/admin/users/existingUserQuery/remove",
																						data : JSON
																						...
																						success : function(
																							...
																							if (response.success) {
																								...
																								document
																										.getElementById("loader").style.display = "block";
																								setTimeout(
																										showPage,
																										2000);
																								function showPage() {
																									...
																									$(
																											...
																											.attr(
																													'href',
																													'/olmsb-web/admin/users/existingUserQuery/page');
																								}
																							} else {
	...
	<div class="page-header">
		<h4 id="pagetitle">Existing User Query Result</h4>
	</div>
			...
			<table
				...
				<tbody>
					<c:forEach items="${data}" var="user">
						<tr>
							<td><input id="selectedUsers" name="selecteduser"
								type="checkbox" value="${user.userPk}"></td>
